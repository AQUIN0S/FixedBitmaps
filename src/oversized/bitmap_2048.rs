...
impl Bitmap2048 {
    ...
    pub fn from_set(index: u64) -> Option<Bitmap2048> {
        if index >= TOTAL_BITS {
            return None;
        }
...
mod tests {
    use crate::{
        oversized::bitmap_2048::{ELEMENT_COUNT, ELEMENT_SIZE, TOTAL_BITS},
        Bitmap2048,
    };
    use std::mem::size_of;
