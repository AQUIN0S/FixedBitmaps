...
use fixed_bitmaps::{Bitmap4096, BitmapSize};

const SIZE_USIZE: usize = size_of::<usize>() * 8;
const NUM_ELEMENTS: usize = Bitmap4096::MAP_LENGTH / SIZE_USIZE;
...
#[test]
fn max_works_fine() {
    let bitmap = Bitmap4096::from([usize::MAX; NUM_ELEMENTS]);
    assert_eq!(*bitmap, [usize::MAX; NUM_ELEMENTS]);
}

#[test]
fn copy_test() {
    let a = Bitmap4096::default();
    let mut b = a;
    b += 1;
...
fn and_functionality() {
    let mut a = Bitmap4096::new(false);
    let mut b = Bitmap4096::new(false);
    let mut c = Bitmap4096::new(false);

    let mut array_a = [0; NUM_ELEMENTS];
    let mut array_b = [0; NUM_ELEMENTS];
    let mut array_c = [0; NUM_ELEMENTS];

    let empty_mask = Bitmap4096::default();
    let full_mask = Bitmap4096::new(true);
    ...
    let mut first_test = Bitmap4096::default();
    let mut second_test = Bitmap4096::default();
    let mut third_test = Bitmap4096::default();
...
// #[test]
// fn or_functionality() {
//     let a = Bitmap4096::from(0b11110000);
//     let b = Bitmap4096::from(0b11001100);
//     let c = Bitmap4096::from(0b10101010);

//     let empty_mask = Bitmap4096::default();
//     let full_mask = Bitmap4096::from(u128::MAX);
...
//     let a = Bitmap4096::default();
//     let b = Bitmap4096::from(u128::MAX);
//     let c = Bitmap4096::from(0b1010);

//     assert_eq!(!a, b);
//     assert_eq!(!b, a);

//     // !c is actually 1111...0101
//     assert_ne!(!c, Bitmap4096::from(0b0101));
//     assert_eq!(!c, Bitmap4096::from(u128::MAX - 0b1010));
// }

// #[test]
// #[should_panic]
// fn add_over_limit() {
//     let mut bitmap = Bitmap4096::from(u128::MAX);
//     bitmap += 1;
// }
...
// #[should_panic]
// fn divide_by_0() {
//     let mut bitmap = Bitmap4096::from(1);
//     bitmap /= 0;
// }
