...
fn and_functionality() {
    let mut a = Bitmap2048::new(false);
    let mut b = Bitmap2048::new(false);
    let mut c = Bitmap2048::new(false);

    let mut array_a = [0; NUM_ELEMENTS];
    let mut array_b = [0; NUM_ELEMENTS];
    let mut array_c = [0; NUM_ELEMENTS];

    let empty_mask = Bitmap2048::default();
    let full_mask = Bitmap2048::new(true);
    ...
    let mut first_test = Bitmap2048::default();
    let mut second_test = Bitmap2048::default();
    let mut third_test = Bitmap2048::default();
...
// #[test]
// fn or_functionality() {
//     let a = Bitmap2048::from(0b11110000);
//     let b = Bitmap2048::from(0b11001100);
//     let c = Bitmap2048::from(0b10101010);

//     let empty_mask = Bitmap2048::default();
//     let full_mask = Bitmap2048::from(u128::MAX);
...
//     let a = Bitmap2048::default();
//     let b = Bitmap2048::from(u128::MAX);
//     let c = Bitmap2048::from(0b1010);

//     assert_eq!(!a, b);
//     assert_eq!(!b, a);

//     // !c is actually 1111...0101
//     assert_ne!(!c, Bitmap2048::from(0b0101));
//     assert_eq!(!c, Bitmap2048::from(u128::MAX - 0b1010));
// }

// #[test]
// #[should_panic]
// fn add_over_limit() {
//     let mut bitmap = Bitmap2048::from(u128::MAX);
//     bitmap += 1;
// }
...
// #[should_panic]
// fn divide_by_0() {
//     let mut bitmap = Bitmap2048::from(1);
//     bitmap /= 0;
// }
